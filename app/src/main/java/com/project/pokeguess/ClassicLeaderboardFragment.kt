...
class ClassicLeaderboardFragment : Fragment() {
    companion object {
        ...
        fun newInstance(username: String?): ClassicLeaderboardFragment {
            val fragment = ClassicLeaderboardFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        scrollView = view.findViewById(R.id.leaderboard_classic_view)
